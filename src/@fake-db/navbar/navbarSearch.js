    ...
    data: [
      {
        ...
        title: 'Orders',
        icon: 'ShoppingCart',
        link: '/apps/beauty/orders/list'
      },
      {
        id: 2,
        target: 'beautyAppointments',
        isBookmarked: true,
        title: 'Appointments',
        icon: 'Calendar',
        link: '/apps/beauty/appointments'
      },
      {
        id: 3,
        target: 'feeds',
      ...
      },
      {
        ...
        icon: 'ShoppingBag',
        link: '/apps/beauty/products/products/list'
      }
    ]
  }
]
export const searchArrFood = [
  {
    groupTitle: 'Pages',
    searchLimit: 4,
    data: [
...
mock.onGet('/api/bookmarks/data?business=2').reply(() => {
  const bookmarks = searchArrBeauty[0].data.filter(item => item.isBookmarked)
  const suggestions = searchArrBeauty[0].data
  return [200, { suggestions, bookmarks }]
})

mock.onGet('/api/bookmarks/data?business=1').reply(() => {
  const bookmarks = searchArrFood[0].data.filter(item => item.isBookmarked)
  const suggestions = searchArrFood[0].data
  return [200, { suggestions, bookmarks }]
})

mock.onGet('/api/bookmarks/data?business=0').reply(() => {
  // const business = new URLSearchParams(config.url).get('business')
