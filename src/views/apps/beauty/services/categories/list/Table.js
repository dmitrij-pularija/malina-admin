...
import { getCategories, deleteCategory } from '../store'
...
const CategoriesList = ({ store, categories, sidebarOpen, setSidebarOpen, toggleSidebar, t }) => {
    ...
    <Fragment>
      ...
      <Card className='overflow-hidden'>
        ...
        <DataTable
            ...
            responsive
            paginationServer
            columns={columns(handleEditCategory, handleDelCategory, t)}
            onSort={handleSort}
            sortIcon={<ChevronDown />}
      ...
      <Sidebar store={store} categories={categories} open={sidebarOpen} toggleSidebar={handleClose} selectedCategory={selectedCategory} setSelectedCategory={setSelectedCategory} t={t} />
    </Fragment>
  )
}
