...
// }))
  ...
  const values = selectedCategory ? {
    ...
    description: selectedCategory.category_description ? selectedCategory.category_description : ''} : {}
  ...
  const onSubmit = data => {
    if (checkIsValid(data, requiredFields)) {
      ...
      if (data.description) formData.append('category_description', data.description)
