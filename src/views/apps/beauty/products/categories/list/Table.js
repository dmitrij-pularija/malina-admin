...
const CategoriesList = ({ sidebarOpen, setSidebarOpen, toggleSidebar }) => {
  ...
  const { data, total } = useSelector(state => state.beautyProductsCategories)
  ...
  return (
    <Fragment>
      ...
      <Sidebar open={sidebarOpen} toggleSidebar={handleClose} selectedCategory={selectedCategory} setSelectedCategory={setSelectedCategory} />
    </Fragment>
  )
}
