...
const SpecialtiesList = ({ sidebarOpen, setSidebarOpen, toggleSidebar, t }) => {
    ...
    <Fragment>
      ...
      <Card className='overflow-hidden'>
        <DataTable
            ...
            responsive
            paginationServer
            columns={columns(handleEdit, handleDel, t)}
            onSort={handleSort}
            sortIcon={<ChevronDown />}
      ...
      <Sidebar open={sidebarOpen} toggleSidebar={handleClose} selectedSpecialty={selectedSpecialty} setSelectedSpecialty={setSelectedSpecialty} t={t} />
    </Fragment>
  )
}
